...
l = exp(rnorm(p))*100 
write.table(l, paste0('/home/kl764/project/singlecell/simulation/alterA/l.txt'), 
...
mu = (rnorm(p, sd=0.5))^2
write.table(mu, paste0('/home/kl764/project/singlecell/simulation/alterA/mu.txt'), 
            quote = F, col.names = F, row.names = F)
...
for(j in 1:5){
       ...
       for(i in 1:100){
        ...
        write.table(Y, paste0('/home/kl764/project/singlecell/simulation/alterA/', A, '/read', i, '.txt'), 
                   quote = F, col.names = F, row.names = F)
        write.table(r, paste0('/home/kl764/project/singlecell/simulation/alterA/', A, '/R', i, '.txt'), 
                    quote = F, col.names = F, row.names = F)
       }
}