...
l = exp(rnorm(p))*100 
write.table(l, paste0('/home/kl764/project/singlecell/simulation/alterC.ct/l.txt'), 
...
write.table(mu, paste0('/home/kl764/project/singlecell/simulation/alterC.ct/mu.txt'), 
            quote = F, col.names = F, row.names = F)
...
## Altering Gamma, when alpha=0.1, beta=0.1, nu1=-0.1, nu2=-0.1
A = Alpha[3]
B = Beta[3]
Nu1 = nu1[3]
Nu2 = nu2[3]
...
for(j in 1:5){
        ...
        for(i in 1:100){
                ...
                write.table(Y, paste0('/home/kl764/project/singlecell/simulation/alterC.ct/',  C, '/read', i, '.txt'), 
                           quote = F, col.names = F, row.names = F)
                write.table(r, paste0('/home/kl764/project/singlecell/simulation/alterC.ct/',  C, '/R', i, '.txt'), 
                            quote = F, col.names = F, row.names = F)
        }
