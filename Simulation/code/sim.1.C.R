...
l = exp(rnorm(p))*100 
write.table(l, paste0('/home/kl764/project/singlecell/simulation/alterC/l.txt'), 
...
mu = (rnorm(p, sd=0.5))^2 
write.table(mu, paste0('/home/kl764/project/singlecell/simulation/alterC/mu.txt'), 
            quote = F, col.names = F, row.names = F)
...
for(j in 1:5){
        ...
        write.table(Y, paste0('/home/kl764/project/singlecell/simulation/alterC/',  C, '/read', i, '.txt'), 
                    quote = F, col.names = F, row.names = F)  
        write.table(r, paste0('/home/kl764/project/singlecell/simulation/alterC/',  C, '/R', i, '.txt'), 
                    quote = F, col.names = F, row.names = F)  
        }
}