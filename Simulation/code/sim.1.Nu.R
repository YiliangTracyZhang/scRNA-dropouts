...
l = exp(rnorm(p))*100 
write.table(l, paste0('/home/kl764/project/singlecell/simulation/alterNu/l.txt'), 
...
mu = (rnorm(p, sd=0.5))^2 
write.table(mu, paste0('/home/kl764/project/singlecell/simulation/alterNu/mu.txt'), 
            quote = F, col.names = F, row.names = F)
